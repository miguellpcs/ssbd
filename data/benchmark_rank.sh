...
#echo "id,val,epsilon,univ,query,time_update,time_query,mem_usage,comp_count,comp_mem_avg,value,weight" > baseline_rank_trace.csv
...
baseline_rank_func(){
    ...
    echo "$1,$2,$3,$4,$5,$analysis" >> baseline_rank_trace.csv
}
